...
export default function CustomerRegisterPage() {
  ...
  async function submit(e) {
    ...
    try {
      ...
      const dest = location.state?.from || ROLE_HOME[user.role] || '/menu';
    ...
    <div className="flex min-h-dvh flex-col bg-cream-50">
      ...
      <div className="mx-auto flex w-full max-w-md flex-1 flex-col justify-center px-5 py-10">
        ...
        <p className="mt-2 text-center text-[13px] text-ink-soft">
          Own a restaurant?{' '}
          <Link to="/register" state={{ from }} className="font-bold text-clay-700 hover:underline">Register as restaurant owner</Link>
        </p>
