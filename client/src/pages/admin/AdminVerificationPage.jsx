          ...
          <div className="mt-4 flex items-center gap-4">
            <div className="relative h-16 w-16">
              <svg className="h-16 w-16 -rotate-90" viewBox="0 0 36 36">
                <path d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="#f3e8d8" strokeWidth="3" />
                <path d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="#C24A0E" strokeWidth="3" strokeDasharray={`${completeness}, 100`} />
              </svg>
            ...
            <div className="flex-1 space-y-1.5">
              {requiredChecks.map(c => (
                <div key={c.key} className="flex items-center gap-2 text-sm">
                  {checks[c.key] ? <CheckCircle size={14} className="text-green-500" /> : <AlertTriangle size={14} className="text-yellow-500" />}
