        ...
        <div className="grid gap-10 md:grid-cols-4">
          <div className="md:col-span-2">
            ...
            <p className="mt-3 max-w-md text-sm leading-relaxed text-ink-200">
              Scan, browse, order, enjoy. A smarter way to dine — built for restaurants that care
              about the details.
            </p>
          </div>
          <div>
          ...
          <div>
            <p className="text-xs font-bold uppercase tracking-[0.2em] text-clay-400">Get the app</p>
            <ul className="mt-4 space-y-2.5 text-sm text-ink-200">
              <li>QR ordering</li>
